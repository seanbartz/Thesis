...
\be
\mathcal{S} = \int d^5x \root e^{-2\Phi} \mathcal{L}_{grav} + \int d^5x \root e^{-\Phi} \mathcal{L}_{meson} \, .
\ee 
...
\be
\mathcal{S} = \frac{1}{16\pi G_5}\int d^5 x \root e^{-2\Phi} \left(R + 4 \partial_M \Phi \partial^M \Phi -V(\Phi)\right),
...
&=& \root e^{-2\Phi}\left( e^{-4\Phi/3} \tilde{g}^{MN}\right)\partial_M \Phi \partial_N \Phi, \nonumber \\
&=& \left(e^{10\Phi/3} \sqrt{-g_E}\right) e^{-2\Phi}\left(e^{-4\Phi/3} \tilde{g}^{MN} \right)  \partial_M \Phi \partial_N \Phi, \nonumber \\
&=& \sqrt{-g_E}\partial_M \Phi \partial^M \Phi.
\ea
The Ricci scalar term also produces a term involving the dilaton field under the conformal transformation \cite{carroll},
\ba 
\root e^{-2\Phi} R &=& \sqrt{-g_E} \tilde{R} -\frac{16}{3} \sqrt{-g_E} e^{10\Phi/3} e^{-2\Phi} g^{MN}\partial_M \Phi \partial_N \Phi, \nonumber \\
&=&  \sqrt{-g_E} \tilde{R} -\frac{16}{3} \sqrt{-g_E} e^{10\Phi/3} e^{-2\Phi}\left( e^{-4\Phi/3}\tilde{g}^{MN} \right)\partial_M \Phi \partial_N \Phi, \nonumber \\
&=&  \sqrt{-g_E} \tilde{R} -\frac{16}{3} \sqrt{-g_E}\partial_M \Phi \partial^M \Phi.
\ea
...
\be
\mathcal{S}_E=\frac{1}{16\pi G_5} \int d^5x \sqrt{-g_E} \left(\tilde{R} -\thalf\partial_M \phi \partial^M \phi -\tilde{V}(\phi)  \right),
...
e^{2\phi/\rt6}\frac{z^2}{L^2}\left[\frac{\rt6}{2}\phi'' - \frac{3}{2}\phi'^2 -3\rt6 \phi' -\frac{12}{z^2} \right]&=&\tilde{V}(\phi), \label{eq:dilEOM1}\\
e^{2\phi/\rt6}\frac{z^2}{L^2}\left[\phi'' -3\phi'\left(\frac{1}{z} +\frac{ \phi'}{\rt6}\right) \right]&=& \frac{\partial \tilde{V}}{\partial \phi}. \label{eq:dilEOM2}
\ea
...
\be
\mathcal{S} = \frac{1}{16\pi G_5}\int d^5 x \root e^{-2\Phi} \left(R + 4\partial_M \Phi \partial^M \Phi -\partial_M\chi\partial^M\chi-V(\Phi,\chi)\right).
...
&=& \root e^{-2\Phi}\left( e^{-4\Phi/3} \tilde{g}^{MN}\right)\partial_M \chi \partial_N \chi, \nonumber \\
&=& \left(e^{10\Phi/3}\sqrt{-g_E}\right)e^{-2\Phi}\left(e^{-4\Phi/3} \tilde{g}^{MN} \right)  \partial_M \chi \partial_N \chi, \nonumber \\
...
We make the \emph{ansatz}
\be
\chi(z) =\chi_0 z^n
\ee
for the behavior of the tachyonic field. 
Inserting this \emph{ansatz} into (\ref{eq:EOMnoV}) with the Dirichlet boundary condition $\phi(0)=0$ gives the solution for $\phi$,
\be
\phi(z) = \frac{n\rt6}{12(1+2n)} \chi_0^2 z^{2n}.
\ee
It was shown in \cite{Batell2008,Springer:thesis,, Afonin2009} that such power-law behavior for the tachyonic field with $n=3$ or $n=1$ results in a mass term for $\chi$ that implies $m_\chi^2 L^2 = -3$. 
...
\be
\mathcal{S}_G= \frac{1}{16\pi G_5} \int d^5x \root e^{-2\Phi} \left(R +4\partial_M \Phi \partial^M \Phi -V_G(\Phi)\right), 
\label{eq:altGravAction}
\ee
while the matter action is written as
\be
\mathcal{S}_M  = -\int d^5x \root e^{-\Phi} \mathrm{Tr} \left[ |DX|^2 +\frac{1}{2 g_5^2}(F_A^2 +F_V^2) +V_M(|X|^2,\Phi)\right],
...
\be
\langle \mathcal{S}_M \rangle= -\int d^5x \root e^{-\Phi} \left(\thalf \partial_M\chi\partial^M \chi +V_C(\chi,\Phi)\right),
\ee
