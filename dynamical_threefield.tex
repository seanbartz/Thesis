...
\ba
\cS =\frac{1}{16\pi G_5} \int d^5x \sqrt{-g} e^{-2\Phi}  \left(R+4\partial_M\Phi\partial^M\Phi -\thalf\partial_M \chi \partial^M \chi \right. \nonumber \\
...
\ba
\cS_E=\frac{1}{16\pi G_5} \int d^5x \sqrt{-\tilde{g}}\left(\tilde{R}-\thalf\partial_M\phi\partial^M\phi \right. -\thalf\partial_M\chi\partial^M\chi\nonumber \\
...
\begin{figure}[ht]
\center{\includegraphics[width=\textwidth]{dilaton.eps}}
...
\nopagebreak
\begin{figure}[*hb]
\center{\includegraphics[width=\textwidth]{chiral.eps}}
...
\begin{figure}[ht]
\center{\includegraphics[width=\textwidth]{glueball.eps}}
...
\nopagebreak
\begin{figure}[hb]
\center{\includegraphics[width=\textwidth]{deltaU.eps}}
